...
import './FancyJoinButton.css';

const FancyJoinButton = ({ onClick }) => (
  <button className="button" style={{background: '#4ADE80'}} onClick={onClick}>
    <div className="bg" />
    ...
    <div className="wrap">
      ...
      <div className="content" style={{background: '#4ADE80', color: '#fff'}}>
...
export default FancyJoinButton;
